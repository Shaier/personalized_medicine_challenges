...
questions_list = []
for qa in processed_questions:
    questions_list.append(json.loads(qa))

# Dimensionless
with open('data/transformations/biolinkbert/dimensionless/dimensionless.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], dimensionless_option = True)
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')

# Gender
# male
with open('data/transformations/biolinkbert/gender/male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# female
with open('data/transformations/biolinkbert/gender/female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# Ethnicity
# white
with open('data/transformations/biolinkbert/ethnicity/white.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], ethnicity_option='white')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# black
with open('data/transformations/biolinkbert/ethnicity/black.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], ethnicity_option='black')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# african-american
with open('data/transformations/biolinkbert/ethnicity/African-American.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], ethnicity_option='African-American')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# asian
with open('data/transformations/biolinkbert/ethnicity/asian.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], ethnicity_option='asian')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# hispanic
with open('data/transformations/biolinkbert/ethnicity/hispanic.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], ethnicity_option='hispanic')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# Names
# white
with open('data/transformations/biolinkbert/names/white.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['white']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# black
with open('data/transformations/biolinkbert/names/black.jsonl', 'w') as f:
    for qa in questions_list:
...
# hispanic
with open('data/transformations/biolinkbert/names/hispanic.jsonl', 'w') as f:
    for qa in questions_list:
...
# asian
with open('data/transformations/biolinkbert/names/asian.jsonl', 'w') as f:
    for qa in questions_list:
...
# Gender + Ethnicity
# white male
with open('data/transformations/biolinkbert/gender_ethnicity/white_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', ethnicity_option = 'white')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# black male
with open('data/transformations/biolinkbert/gender_ethnicity/black_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', ethnicity_option = 'black')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
with open('data/transformations/biolinkbert/gender_ethnicity/African-American_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', ethnicity_option = 'African-American')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# hispanic male
with open('data/transformations/biolinkbert/gender_ethnicity/hispanic_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', ethnicity_option = 'hispanic')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# asian male
with open('data/transformations/biolinkbert/gender_ethnicity/asian_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', ethnicity_option = 'asian')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# white female
with open('data/transformations/biolinkbert/gender_ethnicity/white_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', ethnicity_option = 'white')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# black female
with open('data/transformations/biolinkbert/gender_ethnicity/black_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', ethnicity_option = 'black')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# hispanic female
with open('data/transformations/biolinkbert/gender_ethnicity/hispanic_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', ethnicity_option = 'hispanic')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# asian female
with open('data/transformations/biolinkbert/gender_ethnicity/asian_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', ethnicity_option = 'asian')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
with open('data/transformations/biolinkbert/gender_ethnicity/African-American_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', ethnicity_option = 'African-American')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# white male
with open('data/transformations/biolinkbert/gender_names_ethnicity/white_male.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['white_male']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='male', ethnicity_option = 'white'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# black male
with open('data/transformations/biolinkbert/gender_names_ethnicity/black_male.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['black_male']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='male', ethnicity_option = 'black'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# African-American male
with open('data/transformations/biolinkbert/gender_names_ethnicity/African-American_male.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['black_male']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='male', ethnicity_option = 'African-American'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# hispanic male
with open('data/transformations/biolinkbert/gender_names_ethnicity/hispanic_male.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['hispanic_male']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='male', ethnicity_option = 'hispanic'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# asian male
with open('data/transformations/biolinkbert/gender_names_ethnicity/asian_male.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['asian_male']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='male', ethnicity_option = 'asian'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# white female
with open('data/transformations/biolinkbert/gender_names_ethnicity/white_female.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['white_female']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='female', ethnicity_option = 'white'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# black female
with open('data/transformations/biolinkbert/gender_names_ethnicity/black_female.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['black_female']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='female', ethnicity_option = 'black'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# hispanic female
with open('data/transformations/biolinkbert/gender_names_ethnicity/hispanic_female.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['hispanic_female']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='female', ethnicity_option = 'hispanic'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# asian female
with open('data/transformations/biolinkbert/gender_names_ethnicity/asian_female.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['asian_female']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='female', ethnicity_option = 'asian'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# African-American female
with open('data/transformations/biolinkbert/gender_names_ethnicity/African-American_female.jsonl', 'w') as f:
    for qa in questions_list:
        for name_example in names_dict['black_female']:
            dimensioned_sentence = to_name(to_dimensions(qa['sent1'], names_option=True, gender_option='female', ethnicity_option = 'African-American'),name = name_example)
            new_qa = qa.copy()
            new_qa['sent1'] = dimensioned_sentence
            json.dump(new_qa, f)
            f.write('\n')
...
# white male
with open('data/transformations/biolinkbert/sexual_orientation_gender/bisexual_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', sexual_orientation_option = 'bisexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# black male
with open('data/transformations/biolinkbert/sexual_orientation_gender/heterosexual_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', sexual_orientation_option = 'heterosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# African-American male
with open('data/transformations/biolinkbert/sexual_orientation_gender/homosexual_male.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='male', sexual_orientation_option = 'homosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# hispanic male
with open('data/transformations/biolinkbert/sexual_orientation_gender/bisexual_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', sexual_orientation_option = 'bisexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# asian male
with open('data/transformations/biolinkbert/sexual_orientation_gender/heterosexual_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', sexual_orientation_option = 'heterosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# white female
with open('data/transformations/biolinkbert/sexual_orientation_gender/homosexual_female.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], gender_option='female', sexual_orientation_option = 'homosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# Sexual Orientation
# bisexual
with open('data/transformations/biolinkbert/sexual_orientation/bisexual.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], sexual_orientation_option = 'bisexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# homosexual
with open('data/transformations/biolinkbert/sexual_orientation/homosexual.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], sexual_orientation_option = 'homosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')
...
# heterosexual
with open('data/transformations/biolinkbert/sexual_orientation/heterosexual.jsonl', 'w') as f:
    for qa in questions_list:
        dimensioned_sentence = to_dimensions(qa['sent1'], sexual_orientation_option = 'heterosexual')
        new_qa = qa.copy()
        new_qa['sent1'] = dimensioned_sentence
        json.dump(new_qa, f)
        f.write('\n')